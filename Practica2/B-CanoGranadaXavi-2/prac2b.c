...
int main(void) {
    ...
    fprintf(fp, "\n\n(2)\n\n\n- DATA NAIXEMENT MEVA: 27/06/1990\n\n");
    fprintf(fp, "- CLUB ESCOLLIT: Arsenal Fc                        (http://es.wikipedia.org/wiki/Arsenal_Football_Club#Plantilla_2014.2F15)\n\n");
    fprintf(fp, "- JUGADOR QUE COINCIDEIX: Serge Gnabry             (http://es.wikipedia.org/wiki/Serge_Gnabry)\n\n");
    fprintf(fp, "- DATA JULIANA DEL 14/07/2020: %.1f\n\n", datajuliana(14, 7, 2020));
    fprintf(fp, "- INTERVAL DATA JULIANA: [ t-1 (253) = 2459039.5 , t1 (254) = 2459059.5 ]\n\n");
    ...
    fprintf(fp2, "\n                            LES 4 LINEAS ANTERIORS I POSTERIORS A LA DATA JULIANA OBTINGUDA\n\n");
